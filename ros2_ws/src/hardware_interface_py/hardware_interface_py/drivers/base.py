...
class BaseController:
    ...
    def __init__(self, uart_dev_set, buad_set, config_path):
        ...
        self.use_lidar = self.config['base_config']['use_lidar']
        self.extra_sensor = self.config['base_config']['extra_sensor']


    def activate_ser(self):
    ...
    def bus_servo_id_set(self, old_id, new_id):
        ...
        data = {"T":self.config['cmd_config']['cmd_set_servo_id'],"raw":old_id,"new":new_id}
        self.send_command(data)


    def bus_servo_torque_lock(self, input_id, input_status):
        # data = {"T":55,"id":input_id,"status":input_status}
        data = {"T":self.config['cmd_config']['cmd_servo_torque'],"id":input_id,"cmd":input_status}
        self.send_command(data)


    def bus_servo_mid_set(self, input_id):
        # data = {"T":58,"id":input_id}
        data = {"T":self.config['cmd_config']['cmd_set_servo_mid'],"id":input_id}
        self.send_command(data)
