...
CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.o: /home/nvidia/UGV_Rover/ros2_ws/src/image_pipeline/image_proc/src/image_proc.cpp
CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.o: CMakeFiles/image_proc_exe.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/nvidia/UGV_Rover/ros2_ws/build/image_proc/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.o"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.o -MF CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.o.d -o CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.o -c /home/nvidia/UGV_Rover/ros2_ws/src/image_pipeline/image_proc/src/image_proc.cpp
...
CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/nvidia/UGV_Rover/ros2_ws/src/image_pipeline/image_proc/src/image_proc.cpp > CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.i
...
CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/nvidia/UGV_Rover/ros2_ws/src/image_pipeline/image_proc/src/image_proc.cpp -o CMakeFiles/image_proc_exe.dir/src/image_proc.cpp.s
...
image_proc: /usr/local/lib/libopencv_gapi.so.4.10.0
image_proc: /usr/local/lib/libopencv_stitching.so.4.10.0
image_proc: /usr/local/lib/libopencv_aruco.so.4.10.0
image_proc: /usr/local/lib/libopencv_bgsegm.so.4.10.0
image_proc: /usr/local/lib/libopencv_bioinspired.so.4.10.0
image_proc: /usr/local/lib/libopencv_ccalib.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudabgsegm.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudafeatures2d.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudaobjdetect.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudastereo.so.4.10.0
image_proc: /usr/local/lib/libopencv_dnn_objdetect.so.4.10.0
image_proc: /usr/local/lib/libopencv_dnn_superres.so.4.10.0
image_proc: /usr/local/lib/libopencv_dpm.so.4.10.0
image_proc: /usr/local/lib/libopencv_face.so.4.10.0
image_proc: /usr/local/lib/libopencv_freetype.so.4.10.0
image_proc: /usr/local/lib/libopencv_fuzzy.so.4.10.0
image_proc: /usr/local/lib/libopencv_hfs.so.4.10.0
image_proc: /usr/local/lib/libopencv_img_hash.so.4.10.0
image_proc: /usr/local/lib/libopencv_intensity_transform.so.4.10.0
image_proc: /usr/local/lib/libopencv_line_descriptor.so.4.10.0
image_proc: /usr/local/lib/libopencv_mcc.so.4.10.0
image_proc: /usr/local/lib/libopencv_quality.so.4.10.0
image_proc: /usr/local/lib/libopencv_rapid.so.4.10.0
image_proc: /usr/local/lib/libopencv_reg.so.4.10.0
image_proc: /usr/local/lib/libopencv_rgbd.so.4.10.0
image_proc: /usr/local/lib/libopencv_saliency.so.4.10.0
image_proc: /usr/local/lib/libopencv_signal.so.4.10.0
image_proc: /usr/local/lib/libopencv_stereo.so.4.10.0
image_proc: /usr/local/lib/libopencv_structured_light.so.4.10.0
image_proc: /usr/local/lib/libopencv_phase_unwrapping.so.4.10.0
image_proc: /usr/local/lib/libopencv_superres.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudacodec.so.4.10.0
image_proc: /usr/local/lib/libopencv_surface_matching.so.4.10.0
image_proc: /usr/local/lib/libopencv_tracking.so.4.10.0
image_proc: /usr/local/lib/libopencv_datasets.so.4.10.0
image_proc: /usr/local/lib/libopencv_plot.so.4.10.0
image_proc: /usr/local/lib/libopencv_text.so.4.10.0
image_proc: /usr/local/lib/libopencv_videostab.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudaoptflow.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudalegacy.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudawarping.so.4.10.0
image_proc: /usr/local/lib/libopencv_optflow.so.4.10.0
image_proc: /usr/local/lib/libopencv_wechat_qrcode.so.4.10.0
image_proc: /usr/local/lib/libopencv_xfeatures2d.so.4.10.0
image_proc: /usr/local/lib/libopencv_ml.so.4.10.0
image_proc: /usr/local/lib/libopencv_shape.so.4.10.0
image_proc: /usr/local/lib/libopencv_ximgproc.so.4.10.0
image_proc: /usr/local/lib/libopencv_video.so.4.10.0
image_proc: /usr/local/lib/libopencv_xobjdetect.so.4.10.0
image_proc: /usr/local/lib/libopencv_objdetect.so.4.10.0
image_proc: /usr/local/lib/libopencv_dnn.so.4.10.0
image_proc: /usr/local/lib/libopencv_xphoto.so.4.10.0
image_proc: /usr/local/lib/libopencv_photo.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudaimgproc.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudafilters.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudaarithm.so.4.10.0
image_proc: /opt/ros/humble/lib/libcv_bridge.so
image_proc: /opt/ros/humble/lib/libimage_geometry.so
image_proc: /usr/local/lib/libopencv_calib3d.so.4.10.0
image_proc: /usr/local/lib/libopencv_features2d.so.4.10.0
image_proc: /usr/local/lib/libopencv_flann.so.4.10.0
image_proc: /usr/local/lib/libopencv_highgui.so.4.10.0
image_proc: /usr/local/lib/libopencv_videoio.so.4.10.0
image_proc: /usr/local/lib/libopencv_imgcodecs.so.4.10.0
image_proc: /usr/local/lib/libopencv_imgproc.so.4.10.0
image_proc: /usr/local/lib/libopencv_core.so.4.10.0
image_proc: /usr/local/lib/libopencv_cudev.so.4.10.0
image_proc: /opt/ros/humble/lib/aarch64-linux-gnu/libimage_transport.so
...
image_proc: /usr/lib/aarch64-linux-gnu/libconsole_bridge.so.1.0
...
image_proc: /usr/lib/aarch64-linux-gnu/libpython3.10.so
...
image_proc: /home/nvidia/UGV_Rover/ros2_ws/install/tracetools_image_pipeline/lib/libtracetools_image_pipeline.so
image_proc: CMakeFiles/image_proc_exe.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/nvidia/UGV_Rover/ros2_ws/build/image_proc/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable image_proc"
